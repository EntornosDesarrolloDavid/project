...
<body>
	<div id="todo">
		<header>
			...
			<a name="top" href="http://www.proyecto.es/principales/index"><h1>Pokémon</h1></a>
...
?>
				...
				<div class="offcanvas-body">
					...
					<div class="container">
						...
						<div class="d-grid gap-2">
							<a  class="btn btn-primary"  href="http://www.proyecto.es/registro/login">Login</a>
							<a  class="btn btn-primary"  href="http://www.proyecto.es/registro/register">Registrarse</a>
							<?php

							if (Sistema::app()->acceso()->hayUsuario()) {
								if (Sistema::app()->acceso()->puedePermiso(2)){
									?>
									<a  class="btn btn-primary"  href="http://www.proyecto.es/usuarios/indice">Crud Usuarios</a>
									<a  class="btn btn-primary"  href="http://www.proyecto.es/pokemon/indice">Crud Pokémon</a>

									<?php	
								}
								?>
							<a  class="btn btn-primary"  href="http://www.proyecto.es/registro/CerrarSesion">Cerrar Sesión</a>
		...
		if (Sistema::app()->acceso()->puedePermiso(1) && Sistema::app()->acceso()->puedePermiso(5)) {
			$menu = new CMenu(array("¡Consulta la Pokédex!", array("Combates", ["Combates", "combate", "Combate"], ["Administrar Pokémon", "pokemon", "indice"]), "¡Busca Shinies!", "¡Adivina el Texto!"), array(["principales", "pokedex"], ["combate", "combate"], ["principales", "shiny"], ["principales", "adivinar"]));
		}
		...
		<div class="contenido">
			...
			<article id="interior">
				<?php echo "Se ha producido el error ".$mensaje; ?>
			</article><!-- #content -->
